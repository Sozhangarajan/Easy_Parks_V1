...
@Component({
    ...
    <div class="profile-page">
      ...
      <div class="hero-header">
        ...
        <div class="anim-layer">
          <div class="float-shape fs-1"><mat-icon>store</mat-icon></div>
          <div class="float-shape fs-2"><mat-icon>business</mat-icon></div>
      ...
      <div class="main-content">
        ...
        <div class="info-card">
          ...
          <div class="info-row">
            <div class="info-icon bi-earnings">
              <mat-icon>trending_up</mat-icon>
            </div>
            <div class="info-content">
              <span class="info-label">Avg. Rating</span>
              <span class="info-value">4.5 / 5.0</span>
            </div>
          </div>

          <div class="info-row">
            <div class="info-icon bi-rating">
        ...
        <div class="info-card">
          ...
          <button class="settings-row" (click)="switchRole()">
            <div class="settings-left">
              ...
              <div class="settings-text">
                <span class="settings-label">Switch to User</span>
                <span class="settings-desc">Browse and book parking</span>
              </div>
            </div>
          ...
          <button class="settings-row">
            <div class="settings-left">
              ...
              <div class="settings-text">
                ...
                <span class="settings-desc">Booking alerts & updates</span>
              </div>
            </div>
          ...
          <button class="settings-row">
            <div class="settings-left">
              <div class="settings-icon si-auto">
                <mat-icon>auto_awesome</mat-icon>
              </div>
              <div class="settings-text">
                <span class="settings-label">Auto Accept</span>
                <span class="settings-desc">Automatically confirm bookings</span>
              </div>
            </div>
          ...
          <button class="settings-row">
            <div class="settings-left">
              ...
              <div class="settings-text">
                ...
                <span class="settings-desc">FAQs & owner guides</span>
              </div>
            </div>
            <mat-icon class="settings-arrow">chevron_right</mat-icon>
          </button>
          ...
          <button class="settings-row">
            <div class="settings-left">
              ...
              <div class="settings-text">
                ...
                <span class="settings-desc">Data & security</span>
              </div>
            </div>
            <mat-icon class="settings-arrow">chevron_right</mat-icon>
          </button>
  ...
  styles: [`
    ...
    .float-shape mat-icon { font-size: 22px; width: 22px; height: 22px; color: rgba(255,255,255,0.2); }
    .fs-1 { width: 48px; height: 48px; top: 10%; left: 8%; animation-delay: 0s; }
    .fs-2 { width: 40px; height: 40px; top: 45%; right: 10%; border-radius: 50%; animation-delay: -5s; }
    .fs-3 { width: 42px; height: 42px; top: 70%; left: 20%; animation-delay: -8s; }
    @keyframes drift {
    ...
    .orb-1 { width: 180px; height: 180px; top: -50px; left: -40px; background: rgba(242,201,76,0.18); }
    .orb-2 { width: 150px; height: 150px; bottom: -40px; right: -30px; background: rgba(47,155,191,0.2); animation-delay: -2.5s; }
    ...
    /* avatar */
    .avatar-section { text-align: center; margin-bottom: 22px; }
    .avatar-ring {
      position: relative;
      width: 96px;
      height: 96px;
    ...
    .avatar-inner mat-icon { font-size: 42px; width: 42px; height: 42px; color: white; }
    .avatar-edit {
      position: absolute;
      bottom: 0;
      right: 0;
    ...
    .avatar-edit mat-icon { font-size: 16px; width: 16px; height: 16px; color: #0b2f4a; }

    .avatar-section h1 { margin: 0; font-size: 22px; font-weight: 800; color: white; }
    .role-badge {
      display: inline-flex;
      align-items: center;
      gap: 5px;
    ...
    .stat-num { display: block; font-size: 20px; font-weight: 800; color: white; }
    ...
    .card-header mat-icon { font-size: 20px; width: 20px; height: 20px; color: #0f7173; }
    ...
    .info-icon mat-icon { font-size: 18px; width: 18px; height: 18px; color: #0f7173; }
    .bi-type mat-icon { color: #0b2f4a; }
    .bi-earnings mat-icon { color: #138808; }
    .bi-rating mat-icon { color: #FF9933; }

    .info-content { flex: 1; display: flex; flex-direction: column; }
    .info-label { font-size: 11px; color: #9aa8b1; text-transform: uppercase; letter-spacing: 0.3px; }
    .info-value { font-size: 14px; font-weight: 600; color: #0b2f4a; }

    .verified-badge mat-icon { font-size: 18px; width: 18px; height: 18px; color: #138808; }
    ...
    .save-btn:hover { transform: translateY(-1px); box-shadow: 0 6px 16px rgba(15,113,115,0.3); }
    ...
    .settings-icon mat-icon { font-size: 18px; width: 18px; height: 18px; color: white; }
    .si-role { background: linear-gradient(135deg, #0f7173, #2f9bbf); }
    .si-notif { background: linear-gradient(135deg, #FF9933, #e67300); }
    .si-auto { background: linear-gradient(135deg, #8b5cf6, #7c3aed); }
    ...
    .settings-label { font-size: 14px; font-weight: 600; color: #0b2f4a; }
    .settings-desc { font-size: 12px; color: #9aa8b1; }
    .settings-arrow { font-size: 20px; width: 20px; height: 20px; color: #dfe7eb; }
    ...
    .version { text-align: center; font-size: 12px; color: #b0bec5; margin: 0; }
  `],
})
